...
describe("URL module import", () => {
	...
	describe("import { URL } from 'url';", () => {
		...
		it("toString method works", () => {
			const testUrl = new urlModule.URL(
				"/base",
		...
		it("canParse method works", () => {
			...
			expect(
				urlModule.URL.canParse("/foo", "https://example.org/"),
			).toEqual(true);
		});
	});
...
describe("URL class", () => {
	...
	it("should be able to set and get port", () => {
		...
		expect(url.toString()).toEqual(
			"https://www.example.com:21/route/example",
		);
