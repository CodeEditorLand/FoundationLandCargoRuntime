...
describe("TextDecoder", () => {
	it("should be able to decode UTF-16LE labels", () => {
		const ary_u8 = new Uint8Array([
			0x48, 0x00, 0xac, 0x20, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00, 0x20,
...
describe("TextEncoder", () => {
	...
	it("should be able to encodeInto and decode", () => {
		...
		expect(u8Array40).toEqual(
			new Uint8Array([
				104, 111, 110, 111, 32, 45, 32, 91, 231, 130, 142, 93, 32, 109,
				101, 97, 110, 115, 32, 102, 108, 97, 109, 101, 240, 159, 148,
				165, 32, 105, 110, 32, 74, 97, 112, 97, 110, 101, 115, 101,
			]),
		);
