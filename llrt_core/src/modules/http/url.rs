...
impl<'js> URL<'js> {
	...
	#[qjs(get)]
	pub fn hash(&self) -> String { quirks::hash(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn host(&self) -> String { quirks::host(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn hostname(&self) -> String { quirks::hostname(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn href(&self) -> String { quirks::href(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn origin(&self) -> String { quirks::origin(&self.url.borrow()).to_string() }

	#[qjs(get)]
	pub fn password(&self) -> String { quirks::password(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn pathname(&self) -> String { quirks::pathname(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn port(&self) -> String { quirks::port(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn protocol(&self) -> String { quirks::protocol(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn search(&self) -> String { quirks::search(&self.url.borrow()).to_string() }
	...
	#[qjs(get)]
	pub fn search_params(&self) -> &Value<'js> { self.search_params.as_value() }

	#[qjs(get)]
	pub fn username(&self) -> String { quirks::username(&self.url.borrow()).to_string() }
	...
	pub fn to_string(&self) -> String { self.url.borrow().to_string() }
}
...
pub fn domain_to_unicode(domain:&str) -> String { quirks::domain_to_unicode(domain) }

pub fn domain_to_ascii(domain:&str) -> String { quirks::domain_to_ascii(domain) }
...
pub fn file_url_to_path<'js>(ctx:Ctx<'js>, url:Value<'js>) -> Result<String> {
	...
	Ok(PathBuf::from_str(&path).or_throw(&ctx)?.to_string_lossy().to_string())
}
