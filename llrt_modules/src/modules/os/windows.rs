...
pub fn get_type() -> &'static str {
	// In theory there are more types linx MinGW but in practice this is good
	// enough
	"Windows_NT"
}

pub fn get_release() -> &'static str { &OS_RELEASE }

pub fn get_version() -> &'static str { &OS_VERSION }
