...
pub fn set_allow_list(values:Vec<String>) { _ = NET_ALLOW_LIST.set(values); }

pub fn get_allow_list() -> Option<&'static Vec<String>> { NET_ALLOW_LIST.get() }

pub fn set_deny_list(values:Vec<String>) { _ = NET_DENY_LIST.set(values); }

pub fn get_deny_list() -> Option<&'static Vec<String>> { NET_DENY_LIST.get() }
