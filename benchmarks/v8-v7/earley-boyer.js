...
function sc_withHandlerLambda(handler, body) {
	try {
		...
		if (e._internalException) throw e;
...
/*** META ((export #t)) */
var sc_truncate = Number.parseInt;
/*** META ((export #t)) */
...
sc_Hashtable.prototype.toString = () => "#{%hashtable}";
...
sc_InputPort.prototype.isCharReady = () => true;
sc_InputPort.prototype.close = () => {
	// do nothing
};
...
sc_ErrorInputPort.prototype.getNextChar = () => {
	throw "can't read from error-port.";
};
sc_ErrorInputPort.prototype.isCharReady = () => false;
...
sc_OutputPort.prototype.appendJSString = (obj) => {
	/* do nothing */
};
sc_OutputPort.prototype.close = () => {
	/* do nothing */
};
...
sc_ErrorOutputPort.prototype.appendJSString = (s) => {
	throw "don't write on ErrorPort!";
};
sc_ErrorOutputPort.prototype.close = () => {
	/* do nothing */
};
...
var sc_const_4_nboyer;
{
	...
	BgL_setupzd2boyerzd2 = () => true;
	BgL_testzd2boyerzd2 = () => true;
	...
	untranslate_term_nboyer = (term) => {
		...
		if (term instanceof sc_Pair) {
			...
			while (!(L1127 === null)) {
				{
					tail1131.cdr = new sc_Pair(
						untranslate_term_nboyer(L1127.car),
						null,
					);
	...
	tautologyp_nboyer = (sc_x_11, true_lst, false_lst) => {
		...
		while (true) {
			if (
				((sc_tmp1126_10 = is_term_equal_nboyer(
					sc_x_11,
					true_term_nboyer,
				)),
				sc_tmp1126_10 !== false
				...
				((sc_tmp1125_9 = is_term_equal_nboyer(
					sc_x_11,
					false_term_nboyer,
				)),
				sc_tmp1125_9 !== false
				...
				if (
					...
					tmp1125 !== false
						? tmp1125
						: is_term_member_nboyer(x, false_lst)) !== false
				)
				...
				if (((r1 = x.car), (r2 = y.car), r1 === r2) !== false) {
					...
					while (true) {
						if (lst1 === null) return lst2 === null;
							...
							is_term_equal_nboyer(lst1.car, lst2.car) !== false
						) {
							lst1 = lst1.cdr;
							lst2 = lst2.cdr;
						} else return false;
	...
	const_earley = new sc_Pair(
		new sc_Pair(
			...
			new sc_Pair(
				new sc_Pair("\u1E9Ca", null),
				new sc_Pair(
					new sc_Pair("\u1E9Cs", new sc_Pair("\u1E9Cs", null)),
					null,
				),
			),
		),
			...
			return (input) => {
				...
				var BgL_sc_nbzd2derivzd2treesza2_48za2;
				{
					...
					make_states = (
						...
						var sc_states_52;
						{
							sc_states_52 = sc_makeVector(
								BgL_sc_nbzd2toks_50zd2 + 1,
								false,
							);
					...
					forw = (
						...
						{
							sc_state_82 =
								sc_states_67[BgL_sc_statezd2num_68zd2];
							...
							while (true) {
								{
									...
									if (sc_conf_80 >= 0) {
										...
										BgL_sc_confzd2set_79zd2 =
											sc_state_82[sc_conf_80 + 1];
										head = BgL_sc_confzd2set_79zd2[4];
										sc_state_82[0] =
											BgL_sc_confzd2set_79zd2[0];
					...
					nb_deriv_trees = (
						...
						return (
							...
							tmp1124 !== false
								? tmp1124
								: sc_steps_112[prev] < 0) !== false
								? 1
								: ((sc_loop1_116 = (l, sc_n_118) => {
										var nb_ender_trees;
										var nb_prev_trees;
										var conf_set;
										var state;
									...
									sc_loop1_116(
										sc_enders_111[sc_steps_112[prev]],
										0,
									))
						);
					};
	...
	BgL_earleyzd2benchmarkzd2 = () => {
		...
		return (
			...
			BgL_runzd2benchmarkzd2(
				...
				1,
				() => test(k),
				(result) => (sc_display(result), sc_newline(), result == 132),
			)
		);
	};
}
